            ...
            <div key={index + Math.random()} className={item.type === 'q' ? 'flex justify-end' : ''}>
                {item.type === 'q' ? (
                    <li
                        ...
                        className="text-right px-2 py-2 border-8 dark:bg-zinc-700 dark:border-zinc-700 bg-red-100 border-red-100 rounded-tl-3xl rounded-br-3xl rounded-bl-3xl w-fit max-w-[80%] m-5 flex items-center justify-center"
                    >
